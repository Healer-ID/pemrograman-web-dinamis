...
<body>
	<?php
	$nimErr = $namaErr = $jkelErr = $alamatErr = $tgllahirErr = $semesterErr = "";
	$nim = $nama = $jkel = $alamat = $tgllahir = $semester = "";
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		if ($flag) {
			...
			$sql = "INSERT INTO mahasiswa (nim, nama, jkel, alamat, tgllahir, semester) VALUES('$nim', '$nama', '$jkel','$alamat', '$tgllahir', '$semester') ";
			// execute sql insert
	...
	<form action=" <?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
		...
		<table>
                ...
                <tr>
					<td>Semester : </td>
					<td><input type="text" name="semester" placeholder="semester"></input></td>
                    <span class="error"> <?= $semesterErr; ?></span>
				</tr>
				<td>
				<td>
